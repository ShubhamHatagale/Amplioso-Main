                            ...
                            <div className="price-div">
                                <section>
                                    <div className="over-flow-price">
                                        <FadeInUpBtn>
                                            <h5>It is Amplioso.com’s ("Amplioso") policy to respect your privacy regarding any information we may collect while operating our website.</h5>
                                        </FadeInUpBtn>
                                        <div className="faq-boxes">
                                            <div className="policy-content">
                                                <div>
                                                    <p>This privacy policy discloses the privacy practices for www.amplioso.com. This privacy policy applies solely to information collected by this web site. It will notify you of the following:</p>
                                                </div>
